...
class MasterDataProcessorStreamTaskTestSpec extends BaseSpecWithDatasetRegistry {
  ...
  private def insertTestData(postgresConnect: PostgresConnect): Unit = {
    postgresConnect.execute("INSERT INTO datasets (id, type, validation_config, extraction_config, data_schema, router_config, dataset_config, status, created_by, updated_by, created_date, updated_date) VALUES ('d3', 'master-dataset', '{\"validate\":true,\"mode\":\"Strict\"}', '{\"is_batch_event\":true,\"extraction_key\":\"events\"}', '{\"type\":\"object\",\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"properties\":{\"code\":{\"type\":\"string\"},\"manufacturer\":{\"type\":\"string\"}, \"model\":{\"type\":\"string\"},\"variant\":{\"type\":\"string\"},\"modelYear\":{\"type\":\"string\"},\"price\":{\"type\":\"string\"},\"currencyCode\":{\"type\":\"string\"},\"currency\":{\"type\":\"string\"},\"transmission\":{\"type\":\"string\"},\"fuel\":{\"type\":\"string\"},\"dealer\":{\"type\":\"object\",\"properties\":{\"email\":{\"type\":\"string\"},\"locationId\":{\"type\":\"string\"}}}}}', '{\"topic\":\"d3-events\"}', '{\"data_key\":\"code\",\"timestamp_key\":\"date\",\"entry_topic\":\"local.masterdata.ingest\",\"redis_db\":3,\"redis_db_host\":\"localhost\",\"redis_db_port\":"+masterDataConfig.redisPort+"}', 'Live', 'System', 'System',  now(), now());")
    postgresConnect.execute("INSERT INTO datasets (id, type, validation_config, data_schema, router_config, dataset_config, status, created_by, updated_by, created_date, updated_date) VALUES ('d4', 'master-dataset', '{\"validate\":true,\"mode\":\"Strict\"}', '{\"type\":\"object\",\"$schema\":\"http://json-schema.org/draft-04/schema#\",\"properties\":{\"code\":{\"type\":\"string\"},\"manufacturer\":{\"type\":\"string\"},\"model\":{\"type\":\"string\"},\"variant\":{\"type\":\"string\"},\"modelYear\":{\"type\":\"string\"},\"price\":{\"type\":\"string\"},\"currencyCode\":{\"type\":\"string\"},\"currency\":{\"type\":\"string\"},\"seatingCapacity\": {\"type\": \"integer\"}, \"safety\": {\"type\": \"string\"},\"transmission\":{\"type\":\"string\"},\"fuel\":{\"type\":\"string\"},\"dealer\":{\"type\":\"object\",\"properties\":{\"email\":{\"type\":\"string\"},\"locationId\":{\"type\":\"string\"}}}}}', '{\"topic\":\"d34-events\"}', '{\"data_key\":\"code\",\"timestamp_key\":\"date\",\"entry_topic\":\"local.masterdata.ingest\",\"redis_db\":4,\"redis_db_host\":\"localhost\",\"redis_db_port\":"+masterDataConfig.redisPort+"}', 'Live', 'System', 'System',  now(), now());")
    postgresConnect.execute("INSERT INTO dataset_transformations (id, dataset_id, field_key, transformation_function, status, created_by, updated_by, created_date, updated_date) VALUES ('tf3', 'd3', 'dealer.email', '{\"type\":\"mask\",\"expr\":\"dealer.email\"}', 'Live', 'System', 'System', now(), now());")
    postgresConnect.execute("INSERT INTO dataset_transformations (id, dataset_id, field_key, transformation_function, status, created_by, updated_by, created_date, updated_date) VALUES ('tf4', 'd3', 'dealer.locationId', '{\"type\":\"encrypt\",\"expr\":\"dealer.locationId\"}', 'Live', 'System', 'System', now(), now());")
  }
