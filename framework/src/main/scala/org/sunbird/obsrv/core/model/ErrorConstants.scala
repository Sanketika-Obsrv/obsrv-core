...
object ErrorConstants extends Enumeration {
  ...
  val EVENT_SIZE_EXCEEDED = ErrorInternalValue("ERR_EXT_1003", ("Event size has exceeded max configured size of " + SystemConfig.getSystemConfig("maxEventSize", 1048576).longValue()))
  ...
  val SYSTEM_SETTING_NOT_FOUND = ErrorInternalValue("ERR_SYSTEM_SETTING_1026", "System setting not found")
